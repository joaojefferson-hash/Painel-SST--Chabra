...
const DESCRICAO: Record<AbaInventario, string> = {
  equipamentos: "Material interno da Chabra. Cadastre e movimente (transferências) os equipamentos do patrimônio.",
              ...
              <li key={m.id_maquina}>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-0.5 truncate text-xs text-gray-500">
                      {m.id_empresa ? empresaMap.get(m.id_empresa) ?? "Empresa removida" : "Patrimônio Chabra"}
