...
function normalizarChecklistOrganizacional(raw: unknown): AepChecklistOrganizacional {
  ...
  return {
    ...
    falta_autonomia: toResposta(c.falta_autonomia),
    falta_reconhecimento: toResposta(c.falta_reconhecimento),
    ambiguidade_funcoes: toResposta(c.ambiguidade_funcoes),
    comunicacao_deficiente: toResposta(c.comunicacao_deficiente),
    violencia_clientes: toResposta(c.violencia_clientes),
    excesso_controle: toResposta(c.excesso_controle),
    inseguranca_emprego: toResposta(c.inseguranca_emprego),
    mudancas_sem_participacao: toResposta(c.mudancas_sem_participacao),
  };
}
...
export function setorVazioAep(): AepSetor {
  return {
    ...
    checklist_organizacional: {
      ...
      falta_autonomia: "nao",
      falta_reconhecimento: "nao",
      ambiguidade_funcoes: "nao",
      comunicacao_deficiente: "nao",
      violencia_clientes: "nao",
      excesso_controle: "nao",
      inseguranca_emprego: "nao",
      mudancas_sem_participacao: "nao",
    },
    parecer_tecnico: "",
    recomendacoes: "",
    necessita_aet: false,
